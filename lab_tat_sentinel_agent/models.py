"""
Clinical Data Models & Enums for LabTAT Sentinel: Autonomous LIS Specimen Turnaround Time & Bottleneck Forecaster.
...
class AgentAlert:
    ...
    guideline_citation: str = "CLSI EP28-A3 & Westgard Multi-Rule QC"
    timestamp: str = field(default_factory=lambda: datetime.datetime.now(datetime.timezone.utc).isoformat())
