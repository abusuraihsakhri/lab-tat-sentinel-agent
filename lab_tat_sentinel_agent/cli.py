"""
Command-Line Interface for LabTAT Sentinel: Autonomous LIS Specimen Turnaround Time & Bottleneck Forecaster.
"""
import argparse
import csv
import json
...
from .agents import LISOperationsCoordinator
...
def main(argv=None):
    ...
    if args.command == "audit":
        ...
        print(f"  Domain: Laboratory Medicine | Standard: CLSI EP28-A3 & Westgard Multi-Rule QC")
